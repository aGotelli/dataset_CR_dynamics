...
private:
	...
	std::vector<std::tuple<double_t, std::vector<float>, std::vector<float>, std::vector<float>>> dataToSave;

public:
	// void getData(std::vector<std::tuple<double_t, float*, float*, float*>> &returnData)
	void getData(std::vector<std::tuple<double_t, std::vector<float>, std::vector<float>, std::vector<float>>> &returnData)
	{
