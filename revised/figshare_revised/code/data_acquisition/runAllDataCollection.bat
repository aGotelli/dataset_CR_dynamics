...
REM ********************************    MOTORS      ********************************
start "Motor" cmd /k "py read4MotorCircle.py %duration% %output_dir%\dataMotor%postfix%.csv --motor1-id 1 --motor2-id 2 --motor3-id 3 --motor4-id 4 --start-time %start_time%"


REM ********************************    FT SENSOR      ********************************
@REM start "HEX12" cmd /k "py read_resense_ft.py %duration% %output_dir%\dataResenseFT%postfix%.csv --start-time %start_time%"
