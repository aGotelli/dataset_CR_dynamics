function [simulation_results] = initializeStack(q, Config)
...
simulation_results.Qa_stack     = zeros(time_steps, length(q));
simulation_results.tau_stack     = zeros(time_steps, 2);
